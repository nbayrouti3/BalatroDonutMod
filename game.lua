...
function Game:init_item_prototypes()
    ...
    self.P_CENTERS = {
        ...
        -- Common
        j_dancing_dunc=     {order = 151,  unlocked = true,  discovered = false, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 1, cost = 4, name = "Dancing Duncan", pos = {x=4, y=12}, soul_anim_pos = {x=0, y=0}, set = "Joker", effect = "Type Mult", cost_mult = 1.0, config = {duncan = true, friendly = true}},
        j_strawberry=       {order = 152,  unlocked = true,  discovered = false, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 1, cost = 3, name = "Freeze Dried Strawberry", pos = {x=5, y=11}, set = "Joker", effect = "", cost_mult = 1.0, config = {extra = {odds = 4, chips = 50}}, no_pool_flag = 'freeze_dried_broke', friendly = true},
        j_sacrificial=      {order = 153,  unlocked = true,  discovered = false, blueprint_compat = false, perishable_compat = true, eternal_compat = false, rarity = 1, cost = 20, name = 'Sacrificial Joker', pos = {x=2, y=16}, set = 'Joker', effect = "", cost_mult = 1.0, config = {friendly = true}},
        j_moist_chan=       {order = 154,  unlocked = true,  discovered = false, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 1, cost = 4, name = "Moist Chan", pos = {x=8, y=15}, set = "Joker", effect = "", cost_mult = 1.0, config = {extra = {chips = 10, mult = 4}, friendly = true}},
        j_stonks=           {order = 155,  unlocked = true,  discovered = false, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 1, cost = 3, name = "Stonks", pos = {x=5, y=1}, set = 'Joker', effect = "", cost_mult = 1.0, config = {extra = 3, friendly = true}},
        ...
        j_freaky=           {order = 158,  unlocked = true,  discovered = false, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 2, cost = 6, name = "Freaky Joker", pos = {x=6, y=7}, set = "Joker", effect = "Steel Card", cost_mult = 1.0, config = {friendly = true}},

        -- Rare
        j_hauntedjoker=     {order = 159,  unlocked = true,  discovered = false, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 3, cost = 8, name = "Haunted Joker", pos = {x=0, y=16}, set = "Joker", effect = "Spawn Tarot", cost_mult = 1.0, config = {extra=10, friendly = true}},
        j_lion=             {order = 160,  unlocked = true,  discovered = false, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 3, cost = 8, name = "Lion Joker", pos = {x=8, y=16}, set = "Joker", effect = "Steel Card", cost_mult = 1.0, config = {friendly = true}},
        j_twin=             {order = 161,  unlocked = true,  discovered = false, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 3, cost = 8, name = "Joker Twin", pos = {x=5, y=10}, set = "Joker", effect = "Copycat", cost_mult = 1.0, config = {friendly = true}},
        j_singularity=      {order = 162,  unlocked = true,  discovered = false, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 3, cost = 8, name = 'The Singularity', pos = {x=5, y=16}, set = 'Joker', effect = "Retrigger", cost_mult = 1.0, config = {extra = 4, friendly = true}},

        -- Legendary
        j_camou=            {order = 163,  unlocked = true,  discovered = false, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 4, cost = 20, name = "Camou", pos = {x=3, y=16}, soul_pos = {x=4, y=16}, set = "Joker", effect = "Copycat", cost_mult = 1.0, config = {friendly = true}},
        j_phallussy=        {order = 164,  unlocked = true,  discovered = false, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 4, cost = 20, name = "Gambler's Phallussy", pos = {x=0, y=17}, set = "Joker", effect = "", cost_mult = 1.0, config = {friendly = true}},
        j_metajoker=        {order = 165,  unlocked = true,  discovered = false, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 4, cost = 20, name = 'Meta Joker', pos ={x=6, y=16}, soul_pos = {x=7, y=16}, set = 'Joker', effect = "4 And 8 Retrigger", cost_mult = 1.0, config = {extra = {four = 3, eight = 1, two = 7}, friendly = true}},
        j_perfect_loaf =    {order = 166,  unlocked = true,  discovered = false, blueprint_compat = false, perishable_compat = true, eternal_compat = true, rarity = 4, cost = 20, name = "The Perfect Loaf", pos = {x=5, y=14}, set = 'Joker', effect = "Duncan Boost", cost_mult = 1.0, config = {activated = {}, friendly = true}},
