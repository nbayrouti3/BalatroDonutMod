...
function Game:init_item_prototypes()
    ...
    self.P_CENTERS = {
        ...
        -- Custom Jokers ordered by rarity (The order matters because of the Echidna Polygon card effect; when adding new Jokers, please add new ones at the bottom of each rarity.)
        -- Common
        j_strawberry=       {order = 151,  unlocked = true,  discovered = false, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 1, cost = 3, name = "Freeze Dried Strawberry", pos =  {x=4, y=18}, set = "Joker", effect = "", cost_mult = 1.0, config = {extra = {odds = 4, chips = 50}, friendly = true}, no_pool_flag = 'freeze_dried_broke'},
        j_moist_chan=       {order = 152,  unlocked = true,  discovered = false, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 1, cost = 4, name = "Moist Chan", pos = {x=7, y=17}, set = "Joker", effect = "", cost_mult = 1.0, config = {extra = {chips = 10, mult = 4}, duncan = true, friendly = true}},
        j_stonks=           {order = 153,  unlocked = true,  discovered = false, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 1, cost = 3, name = "Stonks", pos = {x=1, y=18}, set = 'Joker', effect = "", cost_mult = 1.0, config = {extra = 3, duncan = true, friendly = true}},
        j_sopping_wett=     {order = 154,  unlocked = true,  discovered = false, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 1, cost = 3, name = "Sopping Wett", pos = {x=5, y=18}, set = 'Joker', effect = "", cost_mult = 1.0, config = {extra = {odds = 1000, chips = 175}, friendly = true}, yes_pool_flag = 'freeze_dried_broke'},
        ...
        j_cool_duncan=      {order = 156,  unlocked = true,  discovered = false, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 1, cost = 3, name = "Cool Duncan", pos = {x=9, y=16}, set = 'Joker', effect = "", cost_mult = 1.0, config = {extra = {chips_total = 0, chips_add = 10, chips_sub = 5}}, friendly = true},
        ...
        -- Uncommon
        j_part_of_you=      {order = 158,  unlocked = true,  discovered = false, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 2, cost = 8, name = "Part of You", pos = {x=1, y=17}, set = "Joker", effect = "", cost_mult = 1.0, config = {extra = 1, Xmult = 0.15, duncan = true, friendly = true}},
        j_monojoker=        {order = 159,  unlocked = true,  discovered = false, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 2, cost = 6, name = "Monochromatic Joker", pos = {x=1, y=16}, set = "Joker", effect = 'Inverted Suit Multi', cost_mult = 1.0, config = {extra = 2, duncan = true, friendly = true}},
        j_freaky=           {order = 160,  unlocked = true,  discovered = false, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 2, cost = 6, name = "Freaky Joker", pos = {x=9, y=16}, set = "Joker", effect = "Steel Card", cost_mult = 1.0, config = {duncan = true, friendly = true}},
        ...
        j_sacrificial=      {order = 163,  unlocked = true,  discovered = false, blueprint_compat = false,perishable_compat = true, eternal_compat = false,rarity = 2, cost = 20, name = 'Sacrificial Joker', pos = {x=2, y=16}, set = 'Joker', effect = "", cost_mult = 1.0, config = {duncan = true, friendly = true}},        
        j_captured_joker=   {order = 164,  unlocked = true,  discovered = false, blurprint_compat = false,perishable_compat = true, eternal_compat = true, rarity = 2, cost = 7, name = "Captured Joker", pos = {x=2, y=17}, set = 'Joker', effect = "", cost_mult = 1.0, config = {duncan = true, friendly = true}},
        ...
        -- Rare
        j_hauntedjoker=     {order = 166,  unlocked = true,  discovered = false, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 3, cost = 8, name = "Haunted Joker", pos = {x=0, y=16}, set = "Joker", effect = "Spawn Tarot", cost_mult = 1.0, config = {extra=10, duncan = true, friendly = true}},
        j_lion=             {order = 167,  unlocked = true,  discovered = false, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 3, cost = 8, name = "Lion Joker", pos = {x=8, y=16}, set = "Joker", effect = "Steel Card", cost_mult = 1.0, config = {duncan = true, friendly = true}},
        j_twin=             {order = 168,  unlocked = true,  discovered = false, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 3, cost = 8, name = "Joker Twin", pos = {x=9, y=17}, set = "Joker", effect = "Copycat", cost_mult = 1.0, config = {duncan = true, friendly = true}},
        j_singularity=      {order = 169,  unlocked = true,  discovered = false, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 3, cost = 8, name = 'The Singularity', pos = {x=5, y=16}, set = 'Joker', effect = "Retrigger", cost_mult = 1.0, config = {extra = 4, duncan = true, friendly = true}},
        j_shirtless_benzon= {order = 170,  unlocked = true,  discovered = false, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 3, cost = 8, name = "Shirtless Benzon", pos = {x=8, y=17}, set = 'Joker', effect = "Seal Mult", cost_mult = 1.0, config = {extra = 0.25, Xmult = 1, duncan = true, friendly = true}},
        j_linear_aljoka=    {order = 171,  unlocked = true,  discovered = false, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 3, cost = 6, name = "Linear Aljoka", pos ={x=6, y=17}, set = "Joker", effect = "Hand Size Mult", cost_mult = 1.0, config = {duncan = true, friendly = true}},

        -- Legendary
        j_camou=            {order = 172,  unlocked = true,  discovered = false, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 4, cost = 20, name = "Camou", pos = {x=3, y=16}, soul_pos = {x=4, y=16}, set = "Joker", effect = "Copycat", cost_mult = 1.0, config = {duncan = true, friendly = true}},
        j_phallussy=        {order = 173,  unlocked = true,  discovered = false, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 4, cost = 20, name = "Gambler's Phallussy", pos = {x=0, y=17}, set = "Joker", effect = "", cost_mult = 1.0, config = {duncan = true, friendly = true}},
        j_metajoker=        {order = 174,  unlocked = true,  discovered = false, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 4, cost = 20, name = 'Meta Joker', pos ={x=6, y=16}, soul_pos = {x=7, y=16}, set = 'Joker', effect = "4 And 8 Retrigger", cost_mult = 1.0, config = {extra = {four = 3, eight = 1, two = 7}, duncan = true, friendly = true}},
        j_perfect_loaf=     {order = 175,  unlocked = true,  discovered = false, blueprint_compat = false, perishable_compat = true, eternal_compat = true, rarity = 4, cost = 20, name = "The Perfect Loaf", pos = {x=5, y=17}, soul_pos = {x=4, y=17}, set = 'Joker', effect = "Duncan Boost", cost_mult = 1.0, config = {activated = {}, friendly = true}},
        ...
        c_nonagon=          {order = 7,    discovered = false,  cost = 4, consumeable = true, name = "Nonagon Lion", pos = {x=2,y=6}, set = "Polygon", config = {extra = {rounds_needed = 1,}, max_highlighted = 5}},
        ...
        m_bugged =  {max = 500, order = 10, name = "Bugged Card", set = "Enhanced", pos = {x=0,y=5}, effect = "Bugged Card", label = "Bugged Card", config = {extra = {max = 10, min = 0}, mult = nil or 0}},
        ...
        p_friendly_buffoon_normal_1 =        {order = 33, discovered = false, name = "Friendly Buffoon Pack", weight = 0.6, kind = 'Friendly Buffoon', cost = 4, pos = {x=0,y=10}, atlas = 'Booster', set = 'Booster', config = {extra = 2, choose = 1}},
        p_friendly_buffoon_normal_2 =        {order = 34, discovered = false, name = "Friendly Buffoon Pack", weight = 0.6, kind = 'Friendly Buffoon', cost = 4, pos = {x=1,y=10}, atlas = 'Booster', set = 'Booster', config = {extra = 2, choose = 1}},
        p_friendly_buffoon_jumbo_1 =         {order = 35, discovered = false, name = "Jumbo Friendly Buffoon Pack", weight = 0.6, kind = 'Friendly Buffoon', cost = 6, pos = {x=2,y=10}, atlas = 'Booster', set = 'Booster', config = {extra = 4, choose = 1}},
        p_friendly_buffoon_mega_1 =          {order = 36, discovered = false, name = "Mega Friendly Buffoon Pack", weight = 0.15, kind = 'Friendly Buffoon', cost = 8, pos = {x=3,y=10}, atlas = 'Booster', set = 'Booster', config = {extra = 4, choose = 2}},
    ...
    for k, v in pairs(self.P_CENTERS) do
        ...
        if not v.wip then 
            ...
            if v.rarity and v.set == 'Joker' and not v.demo then 
                ...
                if v.config.friendly then table.insert(self.P_FRIENDLY_JOKER_RARITY_POOLS[v.rarity], v) end
            end
        end
    end
