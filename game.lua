...
function Game:init_item_prototypes()
    ...
    self.P_CENTERS = {
        ...
        j_monojoker=        {order = 155,  unlocked = true,  discovered = false, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 2, cost = 6, name = "Monochromatic Joker", pos = {x=1, y=16}, set = "Joker", effect = 'Inverted Suit Multi', cost_mult = 1.0, config = {extra = 2, friendly = true}},
        j_freaky=           {order = 156,  unlocked = true,  discovered = false, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 2, cost = 6, name = "Freaky Joker", pos = {x=9, y=16}, set = "Joker", effect = "Steel Card", cost_mult = 1.0, config = {friendly = true}},
        j_dancing_dunc=     {order = 157,  unlocked = true,  discovered = false, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 2, cost = 6, name = "Dancing Duncan", pos = {x=0, y=18}, soul_anim_pos = {x=0, y=0}, set = "Joker", effect = "Type Mult", cost_mult = 1.0, config = {duncan = true, friendly = true}},
        j_morally_complex=  {order = 158,  unlocked = true,  discovered = false, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 2, cost = 5, name = "Morally Complex Joker", pos = {x=6, y=11}, set = 'Joker', effect = "", cost_mult = 1.0, config = {friendly = true}},
        j_sacrificial=      {order = 159,  unlocked = true,  discovered = false, blueprint_compat = false, perishable_compat = true, eternal_compat = false, rarity = 2, cost = 20, name = 'Sacrificial Joker', pos = {x=2, y=16}, set = 'Joker', effect = "", cost_mult = 1.0, config = {friendly = true}},        
        ...
        -- Rare
        j_hauntedjoker=     {order = 162,  unlocked = true,  discovered = false, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 3, cost = 8, name = "Haunted Joker", pos = {x=0, y=16}, set = "Joker", effect = "Spawn Tarot", cost_mult = 1.0, config = {extra=10, friendly = true}},
        j_lion=             {order = 163,  unlocked = true,  discovered = false, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 3, cost = 8, name = "Lion Joker", pos = {x=8, y=16}, set = "Joker", effect = "Steel Card", cost_mult = 1.0, config = {friendly = true}},
        j_twin=             {order = 164,  unlocked = true,  discovered = false, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 3, cost = 8, name = "Joker Twin", pos = {x=9, y=17}, set = "Joker", effect = "Copycat", cost_mult = 1.0, config = {friendly = true}},
        j_singularity=      {order = 165,  unlocked = true,  discovered = false, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 3, cost = 8, name = 'The Singularity', pos = {x=5, y=16}, set = 'Joker', effect = "Retrigger", cost_mult = 1.0, config = {extra = 4, friendly = true}},
        j_shirtless_benzon= {order = 166,  unlocked = true,  discovered = false, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 3, cost = 8, name = "Shirtless Benzon", pos = {x=8, y=17}, set = 'Joker', effect = "Seal Mult", cost_mult = 1.0, config = {extra = 0.25, Xmult = 1, friendly = true}},
        j_linear_aljoka=    {order = 167,  unlocked = true,  discovered = false, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 3, cost = 6, name = "Linear Aljoka", pos ={x=6, y=17}, set = "Joker", effect = "Hand Size Mult", cost_mult = 1.0, config = {friendly = true}},
