...
function Game:init_item_prototypes()
    ...
    self.P_CENTERS = {
        ...
        j_freaky=           {order = 157,  unlocked = true,  discovered = false, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 2, cost = 6, name = "Freaky Joker", pos = {x=6, y=7}, set = "Joker", effect = "Steel Card", cost_mult = 1.0, config = {friendly = true}},
        ...
        j_perfect_loaf=     {order = 169,  unlocked = true,  discovered = false, blueprint_compat = false, perishable_compat = true, eternal_compat = true, rarity = 4, cost = 20, name = "The Perfect Loaf", pos = {x=5, y=14}, set = 'Joker', effect = "Duncan Boost", cost_mult = 1.0, config = {activated = {}, friendly = true}},
