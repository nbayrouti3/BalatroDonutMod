...
function Game:init_item_prototypes()
    ...
    self.P_CENTERS = {
        ...
        j_strawberry=       {order = 157, unlocked = true, discovered = true, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 1, cost = 3, name = "Freeze Dried Strawberry", pos = {x=5, y=11}, set = "Joker", effect = "", cost_mult = 1.0, config = {extra = {chips = 50, chance = 4}, friendly = true},},
        ...
        j_perfect_loaf =    {order = 165, unlocked = true, discovered = true, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 4, cost = 20, name = "The Perfect Loaf", pos = {x=5, y=14}, set = 'Joker', effect = "", cost_mult = 1.0, config = {activated = {}, friendly = true}},
        --All Consumeables
