...
function Game:init_item_prototypes()
    ...
    self.P_CENTERS = {
        ...
        j_dancing_dunc=     {order = 156, unlocked = true, discovered = true, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 1, cost = 4, name = "Dancing Duncan", pos = {x=4, y=12}, soul_anim_pos = {x=0, y=0}, set = "Joker", effect = "Type Mult", cost_mult = 1.0, config = {duncan = true, friendly = true}},
        j_strawberry=       {order = 157, unlocked = true, discovered = true, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 1, cost = 3, name = "Freeze Dried Strawberry", pos = {x=5, y=11}, set = "Joker", effect = "", cost_mult = 1.0, config = {extra = {odds = 4, chips = 50}}, no_pool_flag = 'freeze_dried_broke', friendly = true},
        ...
        j_moist_chan=       {order = 163,  unlocked = true, discovered = true, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 1, cost = 4, name = "Moist Chan", pos = {x=8,y=15}, set = "Joker", effect = "", cost_mult = 1.0, config = {extra = {chips = 10, mult = 4}, friendly = true}},
        j_stonks=           {order = 164, unlocked = true, discovered = true, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 1, cost = 3, name = "Stonks", pos = {x=5, y=1}, set = 'Joker', effect = "", cost_mult = 1.0, config = {extra = 3, friendly = true}},
        j_perfect_loaf =    {order = 165, unlocked = true, discovered = true, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 4, cost = 20, name = "The Perfect Loaf", pos = {x=5, y=14}, set = 'Joker', effect = "Duncan Boost", cost_mult = 1.0, config = {activated = {}, friendly = true}},
        --All Consumeables
        ...
        c_pentagon=         {order = 3,    discovered = true,  cost = 4, consumeable = true, name = "Penta Hand", pos = {x=8,y=5}, set = "Polygon", config = {extra = {rounds_needed = 5}}},
        ...
        c_septagon=         {order = 5,    discovered = true,  cost = 4, consumeable = true, name = "Septabug", pos = {x=0,y=6}, set = "Polygon", config = {extra = {rounds_needed = 7}}},
        ...
        p_friendly_buffoon_normal_1 =        {order = 33, discovered = false, name = "Friendly Buffoon Pack", weight = 0.6, kind = 'Friendly Buffoon', cost = 4, pos = {x=0,y=9}, atlas = 'Booster', set = 'Booster', config = {extra = 2, choose = 1}},
        p_friendly_buffoon_normal_2 =        {order = 34, discovered = false, name = "Friendly Buffoon Pack", weight = 0.6, kind = 'Friendly Buffoon', cost = 4, pos = {x=1,y=9}, atlas = 'Booster', set = 'Booster', config = {extra = 2, choose = 1}},
        p_friendly_buffoon_jumbo_1 =         {order = 35, discovered = false, name = "Jumbo Friendly Buffoon Pack", weight = 0.6, kind = 'Friendly Buffoon', cost = 6, pos = {x=2,y=9}, atlas = 'Booster', set = 'Booster', config = {extra = 4, choose = 1}},
        p_friendly_buffoon_mega_1 =          {order = 36, discovered = false, name = "Mega Friendly Buffoon Pack", weight = 0.15, kind = 'Friendly Buffoon', cost = 8, pos = {x=3,y=9}, atlas = 'Booster', set = 'Booster', config = {extra = 4, choose = 2}},
