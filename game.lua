...
function Game:init_item_prototypes()
    ...
    self.P_CENTERS = {
        ...
        j_freaky=           {order = 160,  unlocked = true,  discovered = false, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 2, cost = 6, name = "Freaky Joker", pos = {x=7, y=18}, set = "Joker", effect = "Steel Card", cost_mult = 1.0, config = {duncan = true, friendly = true}},
        ...
        c_cat_toy=          {order = 19,   discovered = false,  cost = 4, consumeable = true, name = "Cat Toy", pos = {x=2,y=7}, set = "Spectral", config = {extra = 'Biscuit', max_highlighted = 1}},
