...
function Game:init_item_prototypes()
    ...
    self.P_CENTERS = {
        ...
        j_sopping_wett=     {order = 154,  unlocked = true,  discovered = false, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 1, cost = 3, name = "Sopping Wett", pos = {x=5, y=11}, set = 'Joker', effect = "", cost_mult = 1.0, config = {extra = {odds = 1000, chips = 175}}, yes_pool_flag = 'freeze_dried_broke', friendly = true},
