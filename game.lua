...
function Game:init_item_prototypes()
    ...
    self.P_CENTERS = {
        ...
        j_lion=             {order = 153, unlocked = true, discovered = true, blueprint_compat = true, perishable_compat = true, eternal_compat = true, rarity = 3, cost = 4, name = "Lion Joker", pos = {x=10, y=16}, set = "Joker", effect = "Steel Card", cost_mult = 1.0, config = {}, friendly = true},
